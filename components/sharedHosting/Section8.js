  ...
  return (
    <div className={CommonStyle.ContainerWidth}>
      <div className="row my-5 pb-md-5 d-flex align-items-stretch">
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          <svg
            id="a"
          ...
          <h5 className="mt-3 fw-bold">Launch Your Site with a Click</h5>
          <h5>Host multiple sites</h5>
          <p>
        ...
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          ...
          <h5 className="mt-3 fw-bold">Ultrafast PHP</h5>
          <h5>оn GrowBig & GoGeek plans</h5>
          <p>
            Custom PHP setup for great TTFB (time to first byte) and overall
            site speed.
          </p>
          <Link
            href={'#'}
        ...
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          ...
          <h5 className="mt-3 fw-bold">Easy staging tool</h5>
          <h5>оn GrowBig & GoGeek plans</h5>
          <p>
            Create a copy of your site and test changes before pushing them
            live.
          </p>
          <Link
            href={'#'}
        ...
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          ...
          <h5 className="mt-3 fw-bold">Advanced priority support</h5>
          <h5>оn GoGeek plan</h5>
          <p>Issues handled with priority by our top technicians.</p>
          <Link
            href={'#'}
            className="fs-5 text-decoration-none"
            style={{ marginTop: 'auto' }}
        ...
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          ...
          <h5 className="mt-3 fw-bold">Easy Git integration</h5>
          <h5>оn GoGeek plan</h5>
          <p>
        ...
        <div className="col-lg-4 col-sm-6 mt-3 d-flex flex-column mt-5">
          ...
          <h5 className="mt-3 fw-bold">Add white-label clients</h5>
          <h5>оn GoGeek plan</h5>
          <p>
            Give your clients white-label access to the Site Tools of their
            sites.
          </p>
          <Link
            href={'#'}
