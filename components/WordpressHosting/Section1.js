...
export default function Section1() {
  ...
  const scrollToPricing = () => {
    const wordpressPricingSection = localStorage.getItem(
      'wordpressPricingSection'
    )
    if (wordpressPricingSection)
      window.scrollTo(0, Number(wordpressPricingSection))
  }
          ...
          <div className="row mt-5">
            ...
            <div className="col-md-6">
              ...
              <h1 className={`${styles.mainHeading} mt-4`}>
                ...
                hosting for seamless site performance
              </h1>
              <ul
                className="ps-0"
