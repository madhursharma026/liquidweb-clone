    ...
    return (
        ...
        <div className={`${CommonStyle.ContainerWidth} mt-5 py-5`}>
            ...
            >
                ...
                >
                    <source
                        src="https://www.liquidweb.com/wp-content/uploads/2024/05/iStock-1287601917.mp4"
                        type="video/mp4"
                    />
                ...
                >
                    <div className="row">
                        <div className="col-lg-8">
                            ...
                            <div className="mb-4">
                                <h1 className="fw-bold display-4 mb-0" style={{ lineHeight: '1.2' }}>
                                    24/7
                                </h1>
                            ...
                            <div className="mb-5">
                                ...
                                <blockquote className="mt-3 mb-0">
                                    <p className="fs-5 fst-italic">
                                        “We can quickly create new accounts and set up applications.”
                                    </p>
